...
| Error and payload leakage | Closed safe error vocabulary; fixture tests reject hostile structures and prove raw exception details are not reflected. No live payload is committed. | Live response parsing and operational log redaction remain EXEC-202 work. |
