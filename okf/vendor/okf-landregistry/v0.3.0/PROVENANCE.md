# HM Land Registry OKF input provenance

These files are exact, metadata-only inputs from
[`chris-page-gov/okf-LandRegistry` release `v0.3.0`](https://github.com/chris-page-gov/okf-LandRegistry/releases/tag/v0.3.0),
commit `1d708e39f2cde19610d43c5a7f5e36e4a2f947bc`.

Their file digests and release identity are locked in
[`okf/source-lock.json`](../../../source-lock.json). The imported material is retained
under its upstream licence: code is Apache-2.0 and original metadata, evaluation and
