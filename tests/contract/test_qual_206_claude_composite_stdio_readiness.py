...
SCHEMA_PATH = (
    ROOT / "schemas" / "qual-206-claude-composite-stdio-readiness.schema.json"
)
EVIDENCE_PATH = (
    ROOT
    / "tests"
...
SOURCE_COMMIT = "c679b6fd8fb702572da11043d492c3e9e953ad7a"
SOURCE_TREE = "db0d120a7cadc4e9afef79fcc0536c933e809ca4"
SCHEMA_SHA256 = "0999efbed9c9b4267370cf9ee0b66dfe9c36824b2b6ab9d76c3af1f87bfed930"
EVIDENCE_SHA256 = "eecb01a605d678a0fc2a1603e6b3e3be340890b3c9d9c9b5f1a1eb6070043639"
...
EXPECTED_RUNTIME_MATERIALS = {
    "scripts/qual_206_claude_stdio_observer.mjs": (
        "a2ff43f7b478d7395ffd2b1db128284f43d25e610e436dbb2ddf9b538a764b84"
    ),
    "scripts/qual_206_exact_five_event_collector.mjs": (
        "53f09a79cd427ca8edde2d14d4e6abcdca9df18f98d55a1ad40fc30f8f8ac795"
    ),
...
BOUNDARY = (
    "Accepted protected-main Claude Code 2.1.241 strict-modern STDIO "
...
class Qual206ClaudeCompositeStdioReadinessTests(unittest.TestCase):
    @classmethod
    ...
    def test_historical_observation_remains_byte_exact_and_separate(self) -> None:
        ...
        self.assertEqual(
            ...
            "preserved-historical-default-negotiation-result-not-relabelled",
        )
        self.assertEqual(
            {
                item["path"]: item["sha256"]
