...
const CASE_ASSERTIONS = {
  ...
  E13: {
    ...
    assertions: [
      ...
      ["inspection-scope", "Inspection exposes its current server-owned trace separately from the earlier operation's verified receipt and policy trace, without fabricating a new receipt."],
    ],
    limitations: [
