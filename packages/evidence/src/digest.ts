...
export const CANONICAL_DOMAINS = Object.freeze({
  ...
  authorityContextV3: "gis-ai-go.public-authority-context.v3",
  ...
  evidenceReconciliationClaim: "gis-ai-go.evidence-reconciliation-claim.v1",
  evidenceReconciliationIndex: "gis-ai-go.evidence-reconciliation-index.v1",
  evidenceReconciliationResolution: "gis-ai-go.evidence-reconciliation-resolution.v1",
  ...
  evidenceReceiptV3: "gis-ai-go.evidence-receipt.v3",
  evidenceInspectParametersV3: "gis-ai-go.evidence-inspect-parameters.v3",
